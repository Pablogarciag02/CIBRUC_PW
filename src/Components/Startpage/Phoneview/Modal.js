  ...
  return (
    <div id="mymodal" className="h-screen bg-green1 grid content-start ">
        ...
        <div className = "grid justify-items-center m-5 mt-20 p-4  rounded-lg">
            <span className = "text-2xl text-background text-center bg-verydarkgreen p-4 rounded-full w-full"><a href="/CIBRUC_PW/QuienesSomos"> Quienes Somos</a></span>
            <span className = "mt-4 text-2xl text-background text-center  bg-verydarkgreen p-4 rounded-full w-full"><a href="/CIBRUC_PW/QuieroSER"> Quiero Ser un Super SER</a></span>
            <span className = "mt-4 text-2xl text-background text-center bg-verydarkgreen p-4 rounded-full w-full"><a href="/CIBRUC_PW/Contacto"> Contacto</a></span>
        </div> 


        <h1 className='flex justify-center mt-5 mb-2 text-4xl text-center'>Siguenos en Redes Sociales</h1>
