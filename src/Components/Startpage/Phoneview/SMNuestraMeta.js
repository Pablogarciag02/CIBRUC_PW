...
export default function SMNuestraMeta() {
  return (
    <div className='pt-6 pb-10 ' id='nuestraMeta'>
        <div>
            <div className=''>
                <h2 className='flex justify-center text-3xl sm:mx-40 sm:text-6xl' id="about"
                // initial={{x:200}}
                // whileInView={{x:0}}
                ...
                <h1 className='flex justify-center mx-10 text-2xl text-center sm:mx-40 sm:text-3xl'
                // initial={{x:-200}}
                // whileInView={{x:0}}
                // transition={{duration:1}}
                // viewport={{once:true}}
                
                >Nosotros somos un Centro de Investigacion sobre Biodigestiíon Anaerobia, Residuos Urbanos, Agua y Composta</h1>
            </div>
        </div>
        ...
        <div className='mx-10 '>
            <div className='items-center justify-between sm:flex'>
                ...
                // viewport={{once:true}}
                className="sm:w-1/2" src={IMAGES.recycleAbout}></img>
